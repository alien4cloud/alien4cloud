...
public class TopologyController {
    ...
    @RequestMapping(value = "/{topologyId:.+}/nodetemplates/{nodeTemplateName}/property/{propertyName}/isOutput", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
