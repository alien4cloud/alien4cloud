Feature: Manage location policies resources authorizations
  ...
  Background:
    ...
    Given I create a policy resource of type "org.alien4cloud.mock.policies.AntiAffinity" named "AntiAffinity" related to the location "Mount doom orchestrator"/"middle_earth"
    Then I should receive a RestResponse with no error


  @reset
  Scenario: Add / Remove rights to a user on a location policy resource
    Given I grant access to the resource type "LOCATION_POLICY" named "AntiAffinity" to the user "frodon"
    Then I should have following list of users:
      | frodon |
    When I get the authorised users for the resource type "LOCATION_POLICY" named "AntiAffinity"
    Then I should have following list of users:
      | frodon |
    Given I grant access to the resource type "LOCATION_POLICY" named "AntiAffinity" to the user "sam"
    Then I should have following list of users:
      | frodon |
      | sam    |
    When I get the authorised users for the resource type "LOCATION_POLICY" named "AntiAffinity"
    Then I should have following list of users:
      | frodon |
      | sam    |
    Given I revoke access to the resource type "LOCATION_POLICY" named "AntiAffinity" from the user "sam"
    When I get the authorised users for the resource type "LOCATION_POLICY" named "AntiAffinity"
    Then I should have following list of users:
      | frodon |
    Given I revoke access to the resource type "LOCATION_POLICY" named "AntiAffinity" from the user "frodon"
    Then I should not have any authorized users

  @reset
  Scenario: Add / Remove rights to a group on a location policy resource
    Given I grant access to the resource type "LOCATION_POLICY" named "AntiAffinity" to the group "lordOfRing"
    Then I should have following list of groups:
      | lordOfRing |
    When I get the authorised groups for the resource type "LOCATION_POLICY" named "AntiAffinity"
    Then I should have following list of groups:
      | lordOfRing |
    Given I grant access to the resource type "LOCATION_POLICY" named "AntiAffinity" to the group "hobbits"
    When I get the authorised groups for the resource type "LOCATION_POLICY" named "AntiAffinity"
    Then I should have following list of groups:
      | lordOfRing |
      | hobbits    |
    Given I revoke access to the resource type "LOCATION_POLICY" named "AntiAffinity" from the group "lordOfRing"
    Then I should have following list of groups:
      | hobbits |
    When I get the authorised groups for the resource type "LOCATION_POLICY" named "AntiAffinity"
    Then I should have following list of groups:
  ...
  Scenario: Add / Remove rights to a application on a location policy resource
    ...
    Given I grant access to the resource type "LOCATION_POLICY" named "AntiAffinity" to the application "ALIEN"
    When I get the authorised applications for the resource type "LOCATION_POLICY" named "AntiAffinity"
    Then I should have following list of applications:
      | ALIEN |
    Given I grant access to the resource type "LOCATION_POLICY" named "AntiAffinity" to the application "SDE"
    When I get the authorised applications for the resource type "LOCATION_POLICY" named "AntiAffinity"
    Then I should have following list of applications:
      | ALIEN |
      | SDE   |
    Given I revoke access to the resource type "LOCATION_POLICY" named "AntiAffinity" from the application "ALIEN"
    When I get the authorised applications for the resource type "LOCATION_POLICY" named "AntiAffinity"
    Then I should have following list of applications:
      | SDE |
    Given I grant access to the resource type "LOCATION_POLICY" named "AntiAffinity" to the environment "DEV-ALIEN" of the application "ALIEN"
    When I get the authorised applications for the resource type "LOCATION_POLICY" named "AntiAffinity"
    ...
    Given I grant access to the resource type "LOCATION_POLICY" named "AntiAffinity" to the environment "PRD-ALIEN" of the application "ALIEN"
    When I get the authorised applications for the resource type "LOCATION_POLICY" named "AntiAffinity"
    Then I should have following list of environments:
      | DEV-ALIEN |
      | PRD-ALIEN |
    And I should have following list of applications:
      | ALIEN |
      | SDE   |
    Given I revoke access to the resource type "LOCATION_POLICY" named "AntiAffinity" from the environment "DEV-ALIEN" of the application "ALIEN"
    When I get the authorised applications for the resource type "LOCATION_POLICY" named "AntiAffinity"
    Then I should have following list of environments:
      | PRD-ALIEN |
    And I should have following list of applications:
      | ALIEN |
      | SDE   |
    Given I revoke access to the resource type "LOCATION_POLICY" named "AntiAffinity" from the environment "PRD-ALIEN" of the application "ALIEN"
    When I get the authorised applications for the resource type "LOCATION_POLICY" named "AntiAffinity"
    Then I should not have any authorized environments
    Then I should have following list of applications:
      | SDE |
    Given I revoke access to the resource type "LOCATION_POLICY" named "AntiAffinity" from the application "SDE"
    When I get the authorised applications for the resource type "LOCATION_POLICY" named "AntiAffinity"
  ...
  Scenario: Add / Remove rights to a application/environment_type on a location
    ...
    Given I grant access to the resource type "LOCATION_POLICY" named "AntiAffinity" to the environment type "INTEGRATION_TESTS" of the application "ALIEN"
    When I get the authorised applications for the resource type "LOCATION_POLICY" named "AntiAffinity"
    Then I should have following list of environment types:
      | INTEGRATION_TESTS |
    Then I should have following list of applications:
      | ALIEN |
    Given I revoke access to the resource type "LOCATION_POLICY" named "AntiAffinity" from the environment type "INTEGRATION_TESTS" of the application "ALIEN"
    When I get the authorised applications for the resource type "LOCATION_POLICY" named "AntiAffinity"
