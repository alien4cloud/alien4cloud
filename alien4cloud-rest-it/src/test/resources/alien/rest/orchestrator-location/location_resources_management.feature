Feature: Manage location resources
  ...
  Scenario: Create an on demand resource
    When I create a resource of type "alien.nodes.mock.Compute" named "Small_Ubuntu" related to the location "Mount doom orchestrator"/"Thark location"
    Then I should receive a RestResponse with no error
    When I get the location "Mount doom orchestrator"/"Thark location"
    Then I should receive a RestResponse with no error
    And The location should contains an on-demand resource with name "Small_Ubuntu" and type "alien.nodes.mock.Compute"
  ...
  Scenario: Autogenerate resources
    ...
    When I get the location "Mount doom orchestrator"/"Thark location"
    Then I should receive a RestResponse with no error
    And The location should contains an on-demand resource with name "Medium_Ubuntu" and type "alien.nodes.mock.Compute"
  ...
  Scenario: Delete a location resource should succeed
    Given I create a resource of type "alien.nodes.mock.openstack.Flavor" named "Medium" related to the location "Mount doom orchestrator"/"Thark location"
    And I create a resource of type "alien.nodes.mock.Compute" named "Compute" related to the location "Mount doom orchestrator"/"Thark location"
    And I get the location "Mount doom orchestrator"/"Thark location"
    And The location should contains a resource with name "Medium" and type "alien.nodes.mock.openstack.Flavor"
    And The location should contains an on-demand resource with name "Compute" and type "alien.nodes.mock.Compute"
    When I delete the location resource named "Medium" related to the location "Mount doom orchestrator"/"Thark location"
    Then I should receive a RestResponse with no error
    When I get the location "Mount doom orchestrator"/"Thark location"
    Then The location should not contain a resource with name "Medium" and type "alien.nodes.mock.openstack.Flavor"
  ...
  Scenario: Delete a location on demand resource should succeed
    ...
    Then I should receive a RestResponse with no error
    When I get the location "Mount doom orchestrator"/"Thark location"
    Then The location should not contain an on-demand resource with name "Compute" and type "alien.nodes.mock.Compute"
