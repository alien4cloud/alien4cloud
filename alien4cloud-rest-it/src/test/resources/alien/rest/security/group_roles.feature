Feature: Role attribution to groups
  ...
  Scenario: Role attribution with user added to the group
    ...
    When I create an application with name "Trunk is the best", archive name "trunkisthebest", description "This is the best app for trunk" and topology template id "null"
  ...
  Scenario: Remove a group should remove also the right of user of this group
    ...
    When I create an application with name "freezer is the best", archive name "freezeristhebest", description "This is the best app for freezer" and topology template id "null"
    Then I should receive a RestResponse with no error
    Given I am authenticated with "ADMIN" role
    And I delete the "evil" group
    And I am authenticated with user named "freezer"
    When I create an application with name "freezer is not the best anymore", archive name "freezerisnotthebestanymore", description "This is not the best app anymore for freezer" and topology template id "null"
    Then I should receive a RestResponse with an error code 102
