Feature: Create topology template
  ...
  Scenario:
  Create an empty topology as APPLICATION_MANAGER should raise a permission error
  ...
  Scenario:
  Create an empty topology with an existing name should raise duplication error
