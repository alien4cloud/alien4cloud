...
Background:
 ...
 Scenario: I can set properties constraint for the meta-properties of a cloud
  Given I am authenticated with "ADMIN" role
  And I have the tag "CLOUD_META_2" registered for "cloud"
  And I set the value "TT" for the cloud meta-property "CLOUD_META_1" of the cloud "cloud"
    Then I should receive a RestResponse with no error
  And I set the value "TT" for the cloud meta-property "CLOUD_META_2" of the cloud "cloud"
 ...
 Scenario: Add a tag with an already existing name and target should failed
  Given I am authenticated with "ADMIN" role
  And I have the tag "CLOUD_META_2" registered for "cloud"
  And I create a new tag with name "CLOUD_META_2" and the target "cloud"
