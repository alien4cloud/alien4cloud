Feature: Update substituted Node property
  ...
  Background:
    ...
    And I create a resource of type "org.alien4cloud.nodes.mock.openstack.Image" named "Debian" related to the location "Mount doom orchestrator"/"Thark location"
