...
def installLinuxHttpd(context,builder,currVendor,installScript) {
	...
	builder.sequential {
		echo(message:"apacheLB_install.groovy: Chmodding +x ${context.serviceDirectory}/scripts ...")
		chmod(dir:"${context.serviceDirectory}/scripts", perm:"+x", includes:"*.sh")

		echo(message:"apacheLB_install.groovy: Running ${context.serviceDirectory}/scripts/${installScript} os is ${currVendor}...")
