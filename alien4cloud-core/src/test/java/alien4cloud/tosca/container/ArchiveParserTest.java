...
import alien4cloud.tosca.container.archive.ArchiveValidator;
...
public class ArchiveParserTest {
    ...
    @Test(expected = CSARParsingException.class)
    public void loadingDefinitionWithWrongPathShouldThrowIOExeption() throws CSARParsingException {
        ArchiveParser parser = new ArchiveParser();
        parser.parseDefinitions(Paths.get("file.thatdoesnotexist"));
    }
