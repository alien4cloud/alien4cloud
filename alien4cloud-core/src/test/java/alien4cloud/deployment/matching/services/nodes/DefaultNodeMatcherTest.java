...
public class DefaultNodeMatcherTest {
	...
	public void setUp() throws Exception {
		...
		this.computeNodeType = nodeType("alien.nodes.mock.aws.Compute", "tosca.nodes.Compute");
		this.computeNodeTemplate = nodeTemplate("alien.nodes.mock.aws.Compute");
	...
	@Test
	public void real_world_location_resource_compute_should_be_able_to_match_an_abstract_compute_from_topology()
			throws Exception {
		// Given
		...
		List<LocationResourceTemplate> proposition = nodeMatcher.matchNode(wantedNodeTemplate, wantedNodeType,
	...
	public void location_resource_should_be_matched_only_if_capabilities_are_satisfied() throws Exception {
		...
		capabilityFilterConfiguration.put("alien.nodes.mock.aws.Compute", matchingConfiguration);
		...
		List<LocationResourceTemplate> proposition = nodeMatcher.matchNode(wantedNodeTemplate, nodeType,
