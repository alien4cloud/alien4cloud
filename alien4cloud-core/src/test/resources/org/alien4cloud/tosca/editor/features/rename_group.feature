Feature: Topology editor: rename group operation
  ...
  Scenario: Renaming a group should succeed
    ...
    And The topology SPEL expression "groups['new_simple_group'].members[0]" should return "Compute"
    And The topology SPEL expression "nodeTemplates['Compute'].groups[0]" should return "new_simple_group"
  ...
  Scenario: Renaming an empty group should succeed
    ...
    Then No exception should be thrown
    And The topology SPEL int expression "groups.size()" should return 1
    And The topology SPEL expression "groups['new_simple_group'].members.size()" should return "0"
