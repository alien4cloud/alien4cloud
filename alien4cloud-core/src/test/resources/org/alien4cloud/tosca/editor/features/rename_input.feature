Feature: Topology editor: rename input
  ...
  Scenario: Rename an input should succeed
    ...
    And The topology SPEL expression "inputs['new_simple_input'].type" should return "string"
  ...
  Scenario: Rename an input that is assigned to a node property should succeed
    ...
    And The topology SPEL expression "nodeTemplates['software_component'].properties['component_version'].parameters[0]" should return "the_component_version"