...
#      | type        | org.alien4cloud.tosca.editor.operations.substitution.AddSubstitutionTypeOperation |
#      | elementId   | tosca.nodes.Compute                                                               |
#    Then an exception of type "alien4cloud.exception.InvalidArgumentException" should be thrown
  ...
  ## FIXME broken. check the addSubstitutionTypeOperation processor. since node type TopologyTemplate1:0.1.0-SNAPSHOT is not found
