Feature: Topology editor: delete group operation
  ...
  Scenario: Adding a node to an unexisting group should create the group and succeed
    ...
    And The topology SPEL int expression "groups.size()" should return 0
    And The topology SPEL int expression "nodeTemplates['Compute'].groups.size()" should return 0
