...
println "tomcat_postStart.groovy: Starting ..."
...
if ( loadbalancerService != null ) {
  ...
  println "tomcat_postStart.groovy: ipAddress is ${ipAddress} ..."
  ...
  println "tomcat_postStart.groovy: About to add ${currURL} from ${loadBalancerName} ..."
  loadbalancerService.invoke("addNode", currURL as String, instanceId as String)
}
else {
  println "tomcat_postStart.groovy: waitForService ${loadBalancerName} returned null"
}

println "tomcat_postStart.groovy: Ended"