 ...
 */
@Getter
public class ManagedServiceCreatedEvent extends ManagedServiceEvent {

    private static final long serialVersionUID = 4523559660777770642L;

    public ManagedServiceCreatedEvent(Object source, final ServiceResource serviceResource) {
