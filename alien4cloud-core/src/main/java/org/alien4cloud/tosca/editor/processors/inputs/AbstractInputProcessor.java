...
public abstract class AbstractInputProcessor<T extends AbstractInputOperation> implements IEditorOperationProcessor<T> {
    ...
    public void process(Csar csar, Topology topology, T operation) {
        ...
        processInputOperation(csar, topology, operation, inputs);
    }
    ...
    protected abstract void processInputOperation(Csar csar, Topology topology, T operation, Map<String, PropertyDefinition> inputs);
}
