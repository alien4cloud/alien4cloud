...
//
// var genericForm = require('./generic_form');
//
// var authUser = {
//   'username': 'user',
//   'password': 'user'
...
//     // create a first CSAR
//     common.createCsar(csar0.name, csar0.version, csar0.description);
//
//     // create a second CSAR
//     common.createCsar(csar1.name, csar1.version, csar1.description);
//
...
//     genericForm.saveForm();
//     browser.element(by.binding('GENERIC_FORM.CANCEL')).click();
//
