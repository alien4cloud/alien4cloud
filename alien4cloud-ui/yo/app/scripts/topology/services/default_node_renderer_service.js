      ...
      updateNode: function(nodeGroup, node, nodeTemplate, nodeType, oX, oY, topology) {
        ...
        if(UTILS.isDefinedAndNotNull(nodeTemplate.groups)) {
          ...
          angular.forEach(nodeTemplate.groups, function(value, key) {
            ...
            var rect = D3JS_UTILS.rect(nodeGroup, gX, gY, gW, gH, 3, 3).attr('class', 'node-template-group');
            // the color is generated by hashing the group name
            rect.style('fill', '#' + D3JS_UTILS.string_to_color(value));
