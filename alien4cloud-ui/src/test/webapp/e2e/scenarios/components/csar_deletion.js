...
var topologyTemplatesData = require(__dirname + '/_data/csar/topologytemplates.json');
var topologyTemplateVersionsData = require(__dirname + '/_data/csar/topologytemplateversions.json');
...
describe('CSAR deletion', function() {
  ...
  it('beforeAll', function() {
    ...
    setup.index("topologytemplateversion", "topologytemplateversion", topologyTemplateVersionsData);
    common.home();
