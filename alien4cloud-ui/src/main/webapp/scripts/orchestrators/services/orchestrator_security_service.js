define(function (require) {
  ...
  modules.get('a4c-orchestrators').factory('orchestratorSecurityService', ['$resource',
    function($resource) {
      ...
      var manageOrchestratorUserRoles = $resource('rest/orchestrators/:id/roles/users/:username/:role', {}, {
        'addUserRole': {
          method: 'PUT',
          headers: {
      ...
      var manageOrchestratorGroupRoles = $resource('rest/orchestrators/:id/roles/groups/:groupId/:role', {}, {
        'addGroupRole': {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json; charset=UTF-8'
