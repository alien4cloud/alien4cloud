define(function (require) {
  ...
  modules.get('a4c-common').directive('alienDraggable', ['$rootScope', function($rootScope) {
    return {
      restrict: 'A',
      scope:{
        'enabled':'=dragEnabled',
  ...
  modules.get('a4c-common').directive('alienDroppable', ['$rootScope', function($rootScope) {
    return {
      restrict: 'A',
      scope: {
        data: '=dragData',
