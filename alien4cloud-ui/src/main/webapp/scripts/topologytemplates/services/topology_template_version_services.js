...
define(function (require) {
  ...
  modules.get('a4c-topology-templates', ['ngResource']).factory('topologyTemplateVersionServices', ['$resource',
    function($resource) {
      var searchVersionResource = $resource('rest/latest/templates/:delegateId/versions/search', {}, {
        'search': {
          method: 'POST',
          isArray: false,
          headers: {
      ...
      var versionResource = $resource('rest/latest/templates/:delegateId/versions', {}, {
        'create': {
          method: 'POST',
          isArray: false,
          headers: {
      ...
      var versionMiscResource = $resource('rest/latest/templates/:delegateId/versions/:versionId', {}, {
        'get': {
          method: 'GET'
        },
        'delete': {
