define(function (require) {
  ...
  var NewApplicationCtrl = ['$scope', '$modalInstance', '$resource',
    function($scope, $modalInstance, $resource) {
      ...
      var searchTopologyTemplateResource = $resource('rest/v1/templates/topology/search', {}, {
        'search': {
          method: 'POST',
          isArray: false,
          headers: {
      ...
      var searchTopologyTemplateVersionResource = $resource('rest/v1/templates/:topologyTemplateId/versions/search', {}, {
        'search': {
          method: 'POST',
          isArray: false,
          headers: {
  ...
  modules.get('a4c-applications').controller('ApplicationListCtrl',
    ...
    function($scope, $modal, $state, authService, applicationServices, $translate, toaster, searchServiceFactory) {
      ...
      $scope.searchService = searchServiceFactory('rest/v1/applications/search', false, $scope, 14);
      $scope.searchService.search();
