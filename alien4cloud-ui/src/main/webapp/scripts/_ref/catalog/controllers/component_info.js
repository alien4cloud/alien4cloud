define(function (require) {
  ...
  states.state('catalog.components.detail.info', {
    ...
    controller: 'ComponentInfoCtrl2',
    // menu: {
    //   id: 'catalog.components.detail.info',
  ...
  modules.get('a4c-components', ['ngResource', 'ui.bootstrap', 'ui.router', 'a4c-auth']).controller('ComponentInfoCtrl2',
