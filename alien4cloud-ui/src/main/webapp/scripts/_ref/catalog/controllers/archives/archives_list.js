...
define(function (require) {
  ...
  modules.get('a4c-catalog', ['ui.router', 'ui.bootstrap']).controller('ArchivesListCtrl', ['$scope', '$uibModal', '$state', 'csarService', '$translate', 'toaster', 'authService', 'searchServiceFactory',
