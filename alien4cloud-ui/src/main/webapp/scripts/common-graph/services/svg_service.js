define(function (require) {
  ...
  modules.get('a4c-common-graph', ['a4c-common']).factory('svgServiceFactory', ['svgControlsFactory',
    function(svgControlsFactory) {
      ...
      function SvgGraph (containerElement, svgId, svgClass, toolbarContainer) {
      ...
      return {
        create: function(containerElement, svgId, svgClass, toolbarContainer) {
          return new SvgGraph(containerElement, svgId, svgClass, toolbarContainer);
        }
      };
    } // function
  ]); // factory
