/* global UTILS, d3, dagreD3 */
'use strict';

angular.module('alienUiApp').directive(
  'topologyPlan', ['$filter', '$http', '$modal', 'resizeServices', 'svgServiceFactory', 'runtimeColorsService',
  function($filter, $http, $modal, resizeServices, svgServiceFactory, runtimeColorsService) {
    return {
      restrict : 'E',
      scope : {
        topology: '=',
