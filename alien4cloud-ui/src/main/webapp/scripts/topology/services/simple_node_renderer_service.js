define(function (require) {
  ...
  modules.get('a4c-topology-editor', ['a4c-common']).factory('simpleNodeRendererService', ['commonNodeRendererService', 'toscaService', 'listToMapService',
    function(commonNodeRendererService, toscaService, listToMapService) {
      return {
        isRuntime: false,
        width: 50,
        height: 60,
