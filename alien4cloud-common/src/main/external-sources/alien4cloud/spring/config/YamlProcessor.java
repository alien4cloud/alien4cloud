...
public class YamlProcessor {
     ...
     * YAML documents are separated by <code>---<code> lines, and each document is converted to properties before the match is made. E.g.
     * 
     * <pre>
     * environment: dev
    ...
    private void assignProperties(Properties properties, Map<String, Object> input, String path) {
        for (Entry<String, Object> entry : input.entrySet()) {
            ...
            if (value instanceof String) {
                ...
                properties.setProperty(key, StringUtils.collectionToCommaDelimitedString(collection));
                int count = 0;
